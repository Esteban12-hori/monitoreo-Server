...
def main():
    ...
    parser.add_argument("--token", required=False, help="Token de autenticación")
    parser.add_argument("--interval", type=int, default=2400, help="Intervalo de envío en segundos (defecto: 40 min)")
